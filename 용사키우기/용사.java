...
public class 용사 {
	...
	private void 토벌_고블린동굴() {
		
	}
	private void 토벌_울창한숲() {
		
	}
	private void 토벌_산적전초기지() {
		
	}
	private void 토벌_파괴된도시() {
	
	}
	private void 토벌_마법이깃든숲() {
	
	}
	private void 토벌_마계초원() {
